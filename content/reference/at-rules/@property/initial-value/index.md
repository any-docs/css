...
The **`initial-value`** descriptor of the {{cssxref("@property")}} [at-rule](/guides/Syntax/At-rules) specifies the initial value for the registered [CSS custom property](/reference/properties/--*).
