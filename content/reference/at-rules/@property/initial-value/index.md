...
The **`initial-value`** descriptor of the `@property` [at-rule](/guides/Syntax/At-rules) specifies the initial value for the registered [CSS custom property](/reference/properties/--*).
