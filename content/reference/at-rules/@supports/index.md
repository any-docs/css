...
The **`@supports`** [CSS](/en-US/docs/Web/CSS) [at-rule](/guides/Syntax/At-rules) lets you specify CSS declarations that depend on a browser's support for CSS features.
