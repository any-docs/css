...
The **`scan`** [CSS](/en-US/docs/Web/CSS) [media feature](/en-US/docs/Web/CSS/Reference/At-rules/@media#media_features) is used to apply CSS styles based on the scanning process of the output device.
...
- [Using media queries](/guides/Media_queries/Using) to understand when and how to use a media query.
