...
For a discussion of media query syntax, please see [Using media queries](/guides/Media_queries/Using#syntax).
...
- `print`
  - Intended for paged material and documents viewed on a screen in print preview mode. (Please see [paged media](/guides/Paged_media) for information about formatting issues that are specific to these formats.)
- `screen`
...
For more examples, please see [Using media queries](/guides/Media_queries/Using).
