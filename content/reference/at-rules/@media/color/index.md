...
The **`color`** [CSS](/en-US/docs/Web/CSS) [media feature](/en-US/docs/Web/CSS/Reference/At-rules/@media#media_features) can be used to test the number of bits per color component (red, green, blue) of the output device.
...
See [Applying color to HTML elements using CSS](/guides/Colors/Applying_color) to learn more about using CSS to apply color to HTML.
