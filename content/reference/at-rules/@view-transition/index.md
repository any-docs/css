...
The **`@view-transition`** [CSS](/en-US/docs/Web/CSS) [at-rule](/guides/Syntax/At-rules) is used to opt in the current and destination documents to undergo a [view transition](/en-US/docs/Web/API/View_Transition_API), in the case of a cross-document navigation.
