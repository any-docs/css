...
The **`@font-palette-values`** [CSS](/en-US/docs/Web/CSS) [at-rule](/guides/Syntax/At-rules) allows you to customize the default values of [font-palette](/reference/properties/font-palette) created by the font-maker.
...
The [&lt;dashed-ident&gt;](/reference/values/dashed-ident) is a user defined identifier, that while it looks like a [CSS custom property](/guides/Cascading_variables/Using_custom_properties) behaves in a different way and is not wrapped in a [CSS var() function](/reference/values/var).
