...
The **`override-colors`** [CSS](/en-US/docs/Web/CSS) [descriptor](/en-US/docs/Glossary/CSS_Descriptor) is used to override colors in the chosen [base-palette](/en-US/docs/Web/CSS/Reference/At-rules/@font-palette-values/base-palette) for a color font.
...
The color index is zero-based and any [color value](/reference/values/color_value) can be used.
...
- `[ <integer [0,∞]> <absolute-color-base> ]`
  - Specifies the index of a color in a [base-palette](/en-US/docs/Web/CSS/Reference/At-rules/@font-palette-values/base-palette) and the color to overwrite it with.
