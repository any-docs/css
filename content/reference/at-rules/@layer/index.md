...
The **`@layer`** [CSS](/en-US/docs/Web/CSS) [at-rule](/guides/Syntax/At-rules) is used to declare a cascade layer and can also be used to define the order of precedence in case of multiple cascade layers.
...
The declaration order matters. The first declared layer gets the lowest priority and the last declared layer gets the highest priority. However, the priority is reversed when the [`!important`](/reference/values/important) flag is used.
...
- [`!important`](/reference/values/important)
- `revert-layer`
