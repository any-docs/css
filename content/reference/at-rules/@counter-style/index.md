...
The **`@counter-style`** [CSS](/en-US/docs/Web/CSS) [at-rule](/guides/Syntax/At-rules) lets you extend predefined list styles and define your own counter styles that are not part of the predefined set of styles. The `@counter-style` rule contains [descriptors](#descriptors) defining how the counter value is converted into a string representation.
