...
The **`@keyframes`** [CSS](/en-US/docs/Web/CSS) [at-rule](/guides/Syntax/At-rules) controls the intermediate steps in a CSS animation sequence by defining styles for keyframes (or waypoints) along the animation sequence. This gives more control over the intermediate steps of the animation sequence than [transitions](/guides/Transitions).
...
See [Using CSS animations](/guides/Animations/Using) and [scroll-driven animations](/guides/Scroll-driven_animations/Timelines) for examples.
