...
The **`saturate()`** [CSS](/en-US/docs/Web/CSS) [function](/reference/values/Functions) super-saturates or desaturates the input image. Its result is a {{cssxref("filter-function")}}.
