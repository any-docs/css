...
The **`exp()`** [CSS](/en-US/docs/Web/CSS) [function](/reference/values/Functions) is an exponential function that takes a number as an argument and returns the mathematical constant `e` raised to the power of the given number.
