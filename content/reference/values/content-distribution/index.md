...
The **`<content-distribution>`** {{glossary("enumerated")}} value type is used by `justify-content` and `align-content` properties, and the `place-content` shorthand, to distribute a container's extra space among its {{glossary("alignment subject", "alignment subjects")}}.
