...
The **`fit-content()`** [CSS](/en-US/docs/Web/CSS) [function](/reference/values/Functions) clamps a given size to an available size according to the formula `min(maximum size, max(minimum size, argument))`.
