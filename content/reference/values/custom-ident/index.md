...
The **`<custom-ident>`** [CSS](/en-US/docs/Web/CSS) [data type](/reference/values/Data_types) denotes an arbitrary user-defined string used as an {{glossary("identifier")}}. It is case-sensitive, and certain values are forbidden in various contexts to prevent ambiguity.
