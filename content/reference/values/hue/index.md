...
The **`<hue>`** [CSS](/en-US/docs/Web/CSS) [data type](/reference/values/Data_types) represents the hue angle of a color.
It is used in the color functions that accept hue expressed as a single value, specifically [`hsl()`](/reference/values/color_value/hsl), [`hwb()`](/reference/values/color_value/hwb), [`lch()`](/reference/values/color_value/lch), and [`oklch()`](/reference/values/color_value/oklch) functional notations.
...
The following example shows the effect of changing the `hue` value of the [`hsl()`](/reference/values/color_value/hsl) functional notation on a color.
