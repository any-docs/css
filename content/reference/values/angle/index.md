...
<table class="standard-table">
  <tbody>
    <tr>
      <td><img class="default internal" src="/images/angle90.png" alt="A diagram showing a clockwise 90-degree rotation along a circle by moving from the topmost point to the rightmost point." /></td>
...
<table class="standard-table">
  <tbody>
    <tr>
      <td><img class="default internal" src="/images/angle180.png" alt="A diagram showing a clockwise 180-degree rotation along a circle by moving from the topmost point to the bottommost point." /></td>
...
<table class="standard-table">
  <tbody>
    <tr>
      <td><img class="default internal" src="/images/angleminus90.png" alt="A diagram showing a counterclockwise 90-degree rotation along a circle by moving from the topmost point to the leftmost point." /></td>
      <td><code>-90deg = -100grad = -0.25turn ≈ -1.5708rad</code></td>
    </tr>
  </tbody>
</table>
...
<table class="standard-table">
  <tbody>
    <tr>
      <td><img class="default internal" src="/images/angle0.png" alt="A diagram showing a 0-degree rotation. There is no movement." /></td>
