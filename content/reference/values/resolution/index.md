...
The **`<resolution>`** [CSS](/en-US/docs/Web/CSS) [data type](/reference/values/Data_types), used for describing [resolutions](/en-US/docs/Web/CSS/Reference/At-rules/@media/resolution) in [media queries](/guides/Media_queries), denotes the pixel density of an output device, i.e., its resolution.
