...
- `vw`
  - Represents a percentage of the width of the viewport's initial [containing block](/guides/Display/Containing_block). `1vw` is 1% of the viewport width. For example, if the viewport width is `800px`, then a value of `50vw` on a property will be `400px`.
...
- `vb`
  - Represents the percentage of the size of the initial [containing block](/guides/Display/Containing_block), in the direction of the root element's [block axis](/guides/Logical_properties_and_values).
...
- `vi`
  - Represents a percentage of the size of the initial [containing block](/guides/Display/Containing_block), in the direction of the root element's [inline axis](/guides/Logical_properties_and_values).
...
For more information, see [Container queries](/guides/Containment/Container_queries).
...
When animated, values of the `<length>` data type are interpolated as real, floating-point numbers. The {{glossary("interpolation")}} happens on the calculated value. The speed of the interpolation is determined by the [easing function](/reference/values/easing-function) associated with the animation.
...
- [CSS values & units](/guides/Values_and_units) module
- [Box Model](/guides/Box_model)
