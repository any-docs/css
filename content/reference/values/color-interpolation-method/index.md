...
- `<custom-color-space>`
  - A [`<dashed-ident>`](/reference/values/dashed-ident#using_with_color-profile) referring to a custom [@color profile](/en-US/docs/Web/CSS/Reference/At-rules/@color-profile).
