...
The **`log()`** [CSS](/en-US/docs/Web/CSS) [function](/reference/values/Functions) is an exponential function that returns the logarithm of a number.
