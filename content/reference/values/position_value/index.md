...
When animated, a point's abscissa and ordinate values are interpolated independently. However, because the speed of the interpolation is determined by a single [easing function](/reference/values/easing-function) for both coordinates, the point will move in a straight line.
