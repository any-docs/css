...
The **`image-set()`** [CSS](/en-US/docs/Web/CSS) [functional](/reference/values/Functions) notation is a method of letting the browser pick the most appropriate CSS image from a given set, primarily for high pixel density screens.
