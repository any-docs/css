...
The **`<system-color>`** [CSS](/en-US/docs/Web/CSS) [data type](/reference/values/Data_types) usually reflects the default color choices used for the different parts of a web page.
