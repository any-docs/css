...
- [`matrix()`](/reference/values/transform-function/matrix)
...
- [`perspective()`](/reference/values/transform-function/perspective)
  - Sets the distance between the user and the z=0 plane.

### Rotation

- [`rotate()`](/reference/values/transform-function/rotate)
  - Rotates an element around a fixed point on the 2D plane.
- [`rotate3d()`](/reference/values/transform-function/rotate3d)
  - Rotates an element around a fixed axis in 3D space.
- [`rotateX()`](/reference/values/transform-function/rotateX)
  - Rotates an element around the horizontal axis.
- [`rotateY()`](/reference/values/transform-function/rotateY)
  - Rotates an element around the vertical axis.
- [`rotateZ()`](/reference/values/transform-function/rotateZ)
  - Rotates an element around the z-axis.

### Scaling (resizing)

- [`scale()`](/reference/values/transform-function/scale)
  - Scales an element up or down on the 2D plane.
- [`scale3d()`](/reference/values/transform-function/scale3d)
...
- [`skew()`](/reference/values/transform-function/skew)
...
- [`translateX()`](/reference/values/transform-function/translateX)
  - Translates an element horizontally.
- [`translateY()`](/reference/values/transform-function/translateY)
  - Translates an element vertically.
- [`translateZ()`](/reference/values/transform-function/translateZ)
