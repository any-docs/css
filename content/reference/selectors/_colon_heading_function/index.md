...
> [!NOTE]
> The `:heading()` functional pseudo-class has the same [specificity](/guides/Cascade/Specificity#how_is_specificity_calculated) as a class selector, that is, `0-1-0`. For example, `section:heading()` has a specificity of `0-1-1`.
