...
- The `Document.activeElement` property for regular DOM, and the `ShadowRoot.activeElement` property for [shadow DOM](/en-US/docs/Web/API/Web_components/Using_shadow_DOM) roots.
