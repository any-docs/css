...
The `id_value` value must be a valid [CSS identifier](/reference/values/ident). HTML `id` attributes which are not valid CSS identifiers must be [escaped](/reference/values/ident#escaping_characters) before they can be used in ID selectors.
