...
The `class_name` value must be a valid [CSS identifier](/reference/values/ident). HTML `class` attributes which are not valid CSS identifiers must be [escaped](/reference/values/ident#escaping_characters) before they can be used in class selectors.
