...
The `specificity` of the named view transition pseudo-element is equal to the [specificity of the type selector](/guides/Cascade/Specificity#type_column), unless the parameter used is the universal selector is used, in which case the specificity is zero.
