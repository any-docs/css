...
The **`::first-letter`** [CSS](/en-US/docs/Web/CSS) [pseudo-element](/en-US/docs/Web/CSS/Reference/Selectors/Pseudo-elements) applies styles to the first letter of the first line of a [block container](/guides/Display/Visual_formatting_model#block_containers), but only when not preceded by other content (such as images or inline tables).
...
- All font properties: {{ Cssxref("font") }}, {{ Cssxref("font-style") }}, `font-feature-settings`, `font-kerning`, `font-language-override`, `font-stretch`, `font-synthesis`, {{ Cssxref("font-variant") }}, `font-variant-alternates`, `font-variant-caps`, `font-variant-east-asian`, `font-variant-ligatures`, `font-variant-numeric`, `font-variant-position`, {{ Cssxref("font-weight") }}, {{ Cssxref("font-size") }}, `font-size-adjust`, {{ Cssxref("line-height") }} and {{ Cssxref("font-family") }}
- All background properties: {{ Cssxref("background") }}, {{ Cssxref("background-color") }}, {{ Cssxref("background-image") }}, `background-clip`, `background-origin`, {{ Cssxref("background-position") }}, {{ Cssxref("background-repeat") }}, {{ cssxref("background-size") }}, {{ Cssxref("background-attachment") }}, and `background-blend-mode`
...
- All border properties: the shorthands {{ Cssxref("border") }}, {{ Cssxref("border-style") }}, {{ Cssxref("border-color") }}, {{ cssxref("border-width") }}, {{ cssxref("border-radius") }}, `border-image`, and the longhands properties
- The {{ cssxref("color") }} property
- The {{ cssxref("text-decoration") }}, `text-shadow`, {{ cssxref("text-transform") }}, {{ cssxref("letter-spacing") }}, {{ cssxref("word-spacing") }} (when appropriate), {{ cssxref("line-height") }}, `text-decoration-color`, `text-decoration-line`, `text-decoration-style`, `box-shadow`, {{ cssxref("float") }}, {{ cssxref("vertical-align") }} (only if `float` is `none`) CSS properties
