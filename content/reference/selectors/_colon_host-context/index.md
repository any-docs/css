...
The [specificity](/guides/Cascade/Specificity) of `:host-context()` is that of a [pseudo-class](/en-US/docs/Web/CSS/Reference/Selectors/Pseudo-classes), plus the specificity of the selector passed as the function's argument.
