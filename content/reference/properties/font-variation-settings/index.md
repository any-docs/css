...
The **`font-variation-settings`** [CSS](/en-US/docs/Web/CSS) property provides low-level control over [variable font](/guides/Fonts/Variable_fonts) characteristics by letting you specify the four letter axis names of the characteristics you want to vary along with their values.
...
You can find a number of other variable font examples in our [Variable fonts](/guides/Fonts/Variable_fonts) guide.
...
- [Variable fonts guide](/guides/Fonts/Variable_fonts)
