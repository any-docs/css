...
The transform origin is the point around which a transformation is applied. For example, the transform origin of the [`rotate()`](/reference/values/transform-function/rotate) function is the center of rotation.
