...
For elements rendered as multiple boxes, such as a {{htmlelement("span")}} of text that spans more than one line, the `mask-origin` property specifies which boxes the `box-decoration-break` property operates on to determine the mask positioning area.
...
- `content-box`
  - The position is relative to the [content box](/guides/Shapes/From_box_values#content-box).
- `padding-box`
  - The position is relative to the [padding box](/guides/Shapes/From_box_values#padding-box).
- `border-box`
  - The position is relative to the [border box](/guides/Shapes/From_box_values#border-box).
- `fill-box`
