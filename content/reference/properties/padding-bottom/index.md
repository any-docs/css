...
The **`padding-bottom`** [CSS](/en-US/docs/Web/CSS) property sets the height of the [padding area](/guides/Box_model/Introduction#padding_area) on the bottom of an element.
