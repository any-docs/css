...
The CSS for the container sets it as the source of a scroll timeline named `--square-timeline` using the `scroll-timeline-name` property. No [scrollbar axis](/reference/properties/scroll-timeline-axis) is defined here because the vertical axis will be used by default.
