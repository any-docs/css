...
- In table cell layouts, this property is _ignored_ (see [Box alignment for block, absolutely positioned, and table layouts](/guides/Box_alignment/In_block_abspos_tables))
- In flexbox layouts, this property is _ignored_ (see [Box alignment in flexbox](/guides/Box_alignment/In_flexbox))
- In grid layouts, it aligns the items inside their grid areas on the inline axis (see [Box alignment in grid layout](/guides/Box_alignment/In_grid_layout))
