...
The **`padding-top`** [CSS](/en-US/docs/Web/CSS) property sets the height of the [padding area](/guides/Box_model/Introduction#padding_area) on the top of an element.
