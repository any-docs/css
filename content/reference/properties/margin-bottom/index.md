...
The **`margin-bottom`** [CSS](/en-US/docs/Web/CSS) property sets the [margin area](/guides/Box_model/Introduction#margin_area) on the bottom of an element. A positive value places it farther from its neighbors, while a negative value places it closer.
