...
The **`font-synthesis`** [shorthand](/guides/Cascade/Shorthand_properties) [CSS](/en-US/docs/Web/CSS) property lets you specify whether or not the browser may synthesize the bold, italic, small-caps, and/or subscript and superscript typefaces when they are missing in the specified font-family.
...
- [font-synthesis-weight](/reference/properties/font-synthesis-weight)
- [font-synthesis-style](/reference/properties/font-synthesis-style)
- [font-synthesis-small-caps](/reference/properties/font-synthesis-small-caps)
- [font-synthesis-position](/reference/properties/font-synthesis-position)
...
| font-synthesis value               | [font-synthesis-weight](/reference/properties/font-synthesis-weight) value | [font-synthesis-style](/reference/properties/font-synthesis-style) value | [font-synthesis-small-caps](/reference/properties/font-synthesis-small-caps) value | [font-synthesis-position](/reference/properties/font-synthesis-position) value |
| :--------------------------------- | :-------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------ | :---------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------ |
