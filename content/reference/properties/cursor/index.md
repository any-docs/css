    ...
    <table class="standard-table">
      ...
      <tbody>
        ...
        <tr style="cursor: default">
          ...
          <td><img src="/images/default.gif" alt="wide arrow pointing up and to the left" /></td>
        ...
        <tr style="cursor: context-menu">
          ...
          <td><img alt="wide arrow pointing up and to the left slightly obscuring a menu icon" src="/images/context-menu.png" /></td>
          <td>A context menu is available.</td>
        </tr>
        <tr style="cursor: help">
          <td><code>help</code></td>
          <td><img src="/images/help.gif" alt="wide arrow pointing up and to the left next to a question mark" /></td>
          <td>Help information is available.</td>
        </tr>
        <tr style="cursor: pointer">
          <td><code>pointer</code></td>
          <td><img src="/images/pointer.gif" alt="right hand with an index finger pointing up" /></td>
          <td>
        ...
        <tr style="cursor: progress">
          ...
          <td><img src="/images/progress.gif" alt="wide arrow and hour glass" /></td>
          <td>
        ...
        <tr style="cursor: wait">
          ...
          <td><img src="/images/wait.gif" alt="hour glass" /></td>
          <td>
        ...
        <tr style="cursor: cell">
          ...
          <td><img src="/images/cell.gif" alt="wide plus symbol" /></td>
          <td>The table cell or set of cells can be selected.</td>
        </tr>
        <tr style="cursor: crosshair">
          <td><code>crosshair</code></td>
          <td><img src="/images/crosshair.gif" alt="plus symbol composed of two thin lines." /></td>
          <td>Cross cursor, often used to indicate selection in a bitmap.</td>
        </tr>
        <tr style="cursor: text">
          <td><code>text</code></td>
          <td><img class="default" src="/images/text.gif" alt="vertical i-beam" /></td>
          <td>The text can be selected. Typically the shape of an I-beam.</td>
        </tr>
        <tr style="cursor: vertical-text">
          <td><code>vertical-text</code></td>
          <td><img alt="horizontal i-beam" src="/images/vertical-text.gif" /></td>
          <td>
        ...
        <tr style="cursor: alias">
          ...
          <td><img src="/images/alias.gif" alt="wide arrow pointing up and to the left partially obscuring a smaller folder icon with a curved arrow pointing up and to the right"/></td>
          <td>An alias or shortcut is to be created.</td>
        </tr>
        <tr style="cursor: copy">
          <td><code>copy</code></td>
          <td><img class="default" src="/images/copy.gif" alt="wide arrow pointing up and to the left partially obscuring a smaller folder icon with a plus sign" /></td>
          <td>Something is to be copied.</td>
        </tr>
        <tr style="cursor: move">
          <td><code>move</code></td>
          <td><img src="/images/move.gif" alt="plus sign made of two thin lines. The four points are small arrows facing out" /></td>
          <td>Something is to be moved.</td>
        </tr>
        <tr style="cursor: no-drop">
          <td><code>no-drop</code></td>
          <td>
            <img src="/images/no-drop.gif" alt="pointer icon and a not allowed icon" />
          </td>
          <td>
        ...
        <tr style="cursor: not-allowed">
          ...
          <td><img alt="Not allowed icon, which is a circle with a line through it" src="/images/not-allowed.gif" /></td>
          <td>The requested action will not be carried out.</td>
        </tr>
        <tr style="cursor: grab">
          <td><code>grab</code></td>
          <td><img class="default" src="/images/grab.gif" alt="fully opened hand icon" /></td>
          <td>Something can be grabbed (dragged to be moved).</td>
        </tr>
        <tr style="cursor: grabbing">
          <td><code>grabbing</code></td>
          <td><img class="default" src="/images/grabbing.gif" alt="closed hand icon, of the back of the hand"/></td>
        ...
        <tr style="cursor: all-scroll">
          ...
          <td><img alt="icon of a medium size dot with four triangles around it." src="/images/all-scroll.gif" /></td>
          <td>
        ...
        <tr style="cursor: col-resize">
          ...
          <td><img src="/images/col-resize.gif" alt="two narrow parallel vertical lines with a small arrow pointing left and another pointing right" /></td>
          <td>
        ...
        <tr style="cursor: row-resize">
          ...
          <td><img src="/images/row-resize.gif" alt="two narrow parallel horizontal lines with a small arrow pointing up and another pointing down" /></td>
          <td>
        ...
        <tr style="cursor: sw-resize">
          ...
          <td>
            <img
              ...
              src="/images/sw-resize.gif"
            />
          </td>
        </tr>
        <tr style="cursor: ew-resize">
          <td><code>ew-resize</code></td>
          <td><img alt="thin long arrow pointing left and right" class="default" src="/images/3-resize.gif" /></td>
          <td rowspan="4" style="cursor: auto">Bidirectional resize cursor.</td>
        </tr>
        <tr style="cursor: ns-resize">
          <td><code>ns-resize</code></td>
          <td><img alt="thin long arrow pointing up and down" class="default" src="/images/6-resize.gif" /></td>
        </tr>
        <tr style="cursor: nesw-resize">
          <td><code>nesw-resize</code></td>
          <td><img alt="thin long arrow pointing both to the top-right and bottom-left" class="default" src="/images/1-resize.gif" /></td>
        </tr>
        <tr style="cursor: nwse-resize">
          <td><code>nwse-resize</code></td>
          <td><img alt="thin long arrow pointing both to the top-left and bottom-right" class="default" src="/images/4-resize.gif" /></td>
        </tr>
        <tr style="cursor: zoom-in">
          <th rowspan="2" scope="row" style="cursor: auto">Zooming</th>
          <td><code>zoom-in</code></td>
          <td><img alt="magnifying glass with a plus sign" class="default" src="/images/zoom-in.gif" /></td>
        ...
        <tr style="cursor: zoom-out">
          ...
          <td><img alt="magnifying glass with a minus sign" class="default" src="/images/zoom-out.gif" /></td>
        </tr>
      </tbody>
    </table>
