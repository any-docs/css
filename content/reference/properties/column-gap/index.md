...
Initially a part of [Multi-column Layout](/guides/Multicol_layout), the definition of `column-gap` has been broadened to include multiple layout methods. Now specified in [CSS box alignment](/guides/Box_alignment), it may be used in multi-column, flexible box, and grid layouts.
