...
The **`margin-right`** [CSS](/en-US/docs/Web/CSS) property sets the [margin area](/guides/Box_model/Introduction#margin_area) on the right side of an element. A positive value places it farther from its neighbors, while a negative value places it closer.
...
The vertical margins of two adjacent boxes may fuse. This is called [_margin collapsing_](/guides/Box_model/Margin_collapsing).
