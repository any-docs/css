...
- _Be aware, that will-change may actually influence the visual appearance of elements_, when used with property values, that create a [stacking context](/guides/Positioned_layout/Stacking_context) (e.g., will-change: opacity), as the stacking context is created up front.
