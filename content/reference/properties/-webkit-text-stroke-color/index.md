...
The **`-webkit-text-stroke-color`** [CSS](/en-US/docs/Web/CSS) property specifies the stroke [color](/reference/values/color_value) of characters of text. If this property is not set, the value of the {{cssxref("color")}} property is used.
