...
The **`transition-property`** [CSS](/en-US/docs/Web/CSS) property sets the CSS properties to which a [transition effect](/guides/Transitions/Using) should be applied.
...
See our [Using CSS transitions](/guides/Transitions/Using) guide for more `transition-property` examples.
