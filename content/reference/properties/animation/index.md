...
> [!NOTE]
> Animating [CSS Box Model](/guides/Box_model) properties is discouraged. Animating any box model property is inherently CPU intensive; consider animating the [transform](/reference/properties/transform) property instead.
...
See [Using CSS animations](/guides/Animations/Using#examples) for additional examples.
