...
- `collapse`
  - White space sequences are [collapsed](/guides/Text/Whitespace#collapsing_and_transformation).
- `preserve`
...
> [!NOTE]
> The [CSS text](/guides/Text) module defines a `discard` value for the `white-space-collapse` property to discard all white space in the element, however, this is not supported in any browsers.
