...
The **`widows`** [CSS](/en-US/docs/Web/CSS) property sets the minimum number of lines in a block container that must be shown at the _top_ of a [page](/guides/Paged_media), region, or [column](/guides/Multicol_layout).
