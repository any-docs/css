...
The **`margin`** [CSS](/en-US/docs/Web/CSS) shorthand property sets the [margin area](/guides/Box_model/Introduction#margin_area) on all four sides of an element.
...
A more common method to center an element horizontally is by setting `display: flex;` and [`justify-content: center;`](/reference/properties/justify-content) on a container, which [centers its flex item](/guides/Flexible_box_layout/Aligning_items) children.

### Margin collapsing

Elements' top and bottom margins are sometimes collapsed into a single margin that is equal to the larger of the two margins. See [Mastering margin collapsing](/guides/Box_model/Margin_collapsing) for more information.
