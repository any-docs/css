...
- In table cell layouts, this property is _ignored_. Read more about [alignment in block, absolute positioned and table layout](/guides/Box_alignment/In_block_abspos_tables).
- In flexbox layouts, this property is _ignored_. Read more about [alignment in flexbox](/guides/Box_alignment/In_flexbox).
- In grid layouts, it aligns an item inside its grid area on the inline axis. Read more about [alignment in grid layouts](/guides/Box_alignment/In_grid_layout).
