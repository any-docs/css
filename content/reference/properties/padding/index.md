...
The **`padding`** [CSS](/en-US/docs/Web/CSS) [shorthand property](/guides/Cascade/Shorthand_properties) sets the [padding area](/guides/Box_model/Introduction#padding_area) on all four sides of an element at once.
