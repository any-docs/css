...
The **`box-decoration-break`** [CSS](/en-US/docs/Web/CSS) property specifies how an element's [fragments](/guides/Fragmentation) should be rendered when broken across multiple lines, columns, or pages.
