...
The **`outline-offset`** [CSS](/en-US/docs/Web/CSS) property sets the amount of space between an [outline](/reference/properties/outline) and the edge or border of an element.
