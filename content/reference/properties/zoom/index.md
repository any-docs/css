...
In this first block, of CSS, we are setting the starting value for the `--zoom-level` using [custom properties](/reference/properties/--*) and then using that as the value for `zoom` on the content block.
