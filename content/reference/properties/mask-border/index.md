...
The **`mask-border`** [CSS](/en-US/docs/Web/CSS) [shorthand property](/guides/Cascade/Shorthand_properties) lets you create a mask along the edge of an element's border.
...
```css live-sample___mask-border-example
.masked {
  width: 200px;
