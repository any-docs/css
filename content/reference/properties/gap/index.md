...
The **`gap`** [CSS](/en-US/docs/Web/CSS) [shorthand property](/guides/Cascade/Shorthand_properties) sets the gaps (also called {{glossary("gutters")}}) between rows and columns. This property applies to [multi-column](/guides/Multicol_layout), [flex](/guides/Flexible_box_layout), and [grid](/guides/Grid_layout) containers.
...
This property defines gaps between columns in [CSS multi-column layout](/guides/Multicol_layout), between flex items and flex lines in [CSS flexible box layout](/guides/Flexible_box_layout), and between rows and columns in [CSS grid layout](/guides/Grid_layout).
