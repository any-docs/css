...
The **`mask-border-outset`** [CSS](/en-US/docs/Web/CSS) property specifies the distance by which an element's [mask border](/reference/properties/mask-border) is set out from its border box.
