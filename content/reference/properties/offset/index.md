...
The **`offset`** [CSS](/en-US/docs/Web/CSS) [shorthand property](/guides/Cascade/Shorthand_properties) sets all the properties required for animating an element along a defined path. The offset properties together help to define an _offset transform_, a [transform](/guides/Transforms/Using) that aligns a point in an element ([offset-anchor](/reference/properties/offset-anchor)) to an _offset position_ ([offset-position](/reference/properties/offset-position)) on a path ([offset-path](/reference/properties/offset-path)) at various points along the path ([offset-distance](/reference/properties/offset-distance)) and optionally rotates the element ([offset-rotate](/reference/properties/offset-rotate)) to follow the direction of the path.
