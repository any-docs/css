...
The **`corner-top-left-shape`** [CSS](/en-US/docs/Web/CSS) property specifies the shape of a box's top-left corner, within its `border-radius` area.
...
- `corner-top-right-shape`, `corner-bottom-left-shape`, and `corner-bottom-right-shape`
