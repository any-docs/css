...
The **`view-timeline-axis`** [CSS](/en-US/docs/Web/CSS) property specifies the scroll direction to be used for a [named view progress timeline](/guides/Scroll-driven_animations/Timelines#named_view_progress_timeline).
