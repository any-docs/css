...
The **`clear`** [CSS](/en-US/docs/Web/CSS) property sets whether an element must be moved below (cleared) [floating](/reference/properties/float) elements that precede it. The `clear` property applies to floating and non-floating elements.
...
When applied to non-floating blocks, it moves the [border edge](/guides/Box_model/Introduction#border_area) of the element down until it is below the [margin edge](/guides/Box_model/Introduction#margin_area) of all relevant floats. The non-floated block's top margin collapses.
...
- [CSS basic box model](/guides/Box_model/Introduction)
