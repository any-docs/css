...
- `<geometry-box>`
  - If specified in combination with a `<basic-shape>`, this value defines the reference box for the basic shape. If specified by itself, it causes the edges of the specified box, including any corner shaping (such as a `border-radius`), to be the clipping path. The geometry box can be one of the following values:
    ...
    - `border-box`
      - Uses the [border box](/guides/Shapes/From_box_values#border-box) as the reference box.
    - `padding-box`
      - Uses the [padding box](/guides/Shapes/From_box_values#padding-box) as the reference box.
    - `content-box`
      - Uses the [content box](/guides/Shapes/From_box_values#content-box) as the reference box.
    - `fill-box`
