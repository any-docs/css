...
The **`contain-intrinsic-size`** [CSS](/en-US/docs/Web/CSS) [shorthand property](/guides/Cascade/Shorthand_properties) sets the size of an element that a browser will use for layout when the element is subject to [size containment](/guides/Containment/Using#size_containment).
