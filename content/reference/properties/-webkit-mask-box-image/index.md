...
- [Initial value](/guides/Cascade/Property_value_processing#initial_value): `none`
- Applies to: all elements
- [Inherited](/guides/Cascade/Inheritance): no
- [Computed value](/guides/Cascade/Property_value_processing#computed_value): as specified
