...
The **`corner-bottom-left-shape`** [CSS](/en-US/docs/Web/CSS) property specifies the shape of a box's bottom-left corner, within its `border-radius` area.
...
- `corner-top-left-shape`, `corner-top-right-shape`, and `corner-bottom-right-shape`
