...
The **`view-timeline-name`** [CSS](/en-US/docs/Web/CSS) property specifies the names of one or more [named view progress timelines](/guides/Scroll-driven_animations/Timelines#named_view_progress_timeline) associated with the element.
