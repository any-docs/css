...
You will often need to create a layout which has a number of columns, and CSS provides several ways to do this. Whether you use [Multi-column](/guides/Multicol_layout), [Flexbox](/guides/Flexible_box_layout), or [Grid](/guides/Grid_layout) layout will depend on what you are trying to achieve, and in this recipe we explore these options.
...
- [Guide to Multi-column Layout](/guides/Multicol_layout)
- [Guide to flexbox](/guides/Flexible_box_layout)
- [Guide to CSS grid layout](/guides/Grid_layout)
