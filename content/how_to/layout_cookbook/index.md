...
| ------------------------------------- | -------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| [Media objects][media-objects]        | A two-column box with an image on one side and descriptive text on the other, e.g., a social media post. | [CSS grid][css-grid], `float` fallback, `fit-content` sizing |
...
| [Split navigation][split-navigation]  | A navigation pattern where some links are visually separated from the others.                            | [Flexbox][flexbox], `margin`                                              |
...
[css-grid]: /css/guides/Grid_layout
[multicol]: /css/guides/Multicol_layout
[flexbox]: /css/guides/Flexible_box_layout
[box-alignment]: /css/guides/Box_alignment
