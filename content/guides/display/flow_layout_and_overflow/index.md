...
As we have already learned, using any of these values, other than the default of `visible`, will create a new [block formatting context](/guides/Display/Block_formatting_context).
