...
The [CSS logical properties and values](/guides/Logical_properties_and_values) module includes logical versions of the properties that control margins, padding and borders as well as other mappings for things that we have typically used physical directions to specify.
...
- [Writing Modes](/guides/Writing_modes)
