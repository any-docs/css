...
This guide details the general concepts found in this module. Additional guides provide more information on box alignment in [flexbox](/guides/Box_alignment/In_flexbox), [grid layout](/guides/Box_alignment/In_grid_layout), [multiple-column layout](/guides/Box_alignment/In_multi-column_layout), and [block, absolutely positioned and table layout](/guides/Box_alignment/In_block_abspos_tables). Alignment of text is covered by the [CSS text](/guides/Text) and [CSS inline layout](/guides/Inline_layout) modules.
...
The following examples demonstrate how some of the box alignment properties are applied in [Grid](/guides/Grid_layout) and [Flexbox](/guides/Flexible_box_layout).
