...
The [CSS box alignment](/guides/Box_alignment) module details how alignment works in various layout methods. On this page, we explore how box alignment works in the context of [CSS grid layout](/guides/Grid_layout).

As this guide aims to detail things which are specific to CSS grid layout and Box Alignment, it should be read in conjunction with the [box alignment overview](/guides/Box_alignment/Overview) guide, which details the common features of box alignment across layout methods.
