...
- [Invalid custom properties](/guides/Syntax/Error_handling#invalid_custom_properties)
...
- [CSS `env()`](/reference/values/env) function
- [CSS `calc()`](/reference/values/calc) function
