...
To stack the elements, we can [position](/reference/properties/position#types_of_positioning) them.
...
If the elements are not siblings, the stacking behavior can become more complicated because each element may belong to a different [stacking context](/guides/Positioned_layout/Stacking_context). This is shown in the example below.
