...
In previous guides, we've looked at placing items on the lines created by [defining grid tracks](/guides/Grid_layout/Line-based_placement) and also how to place items [using named template areas](/guides/Grid_layout/Grid_template_areas). In this guide, we look at how these two things work together when we use named lines.
...
Up next, we will look at how CSS grid layout can position items for us without requiring placement properties at all, in the [auto-placement in grid layout](/guides/Grid_layout/Auto-placement) guide.
