...
[CSS grid layout](/guides/Grid_layout) implements [CSS box alignment](/guides/Box_alignment), which is the same standard [flexbox](/guides/Flexible_box_layout) uses for aligning items in its flex container. The alignment module details how alignment should work in all the layout methods.
...
- [Relationship of grid layout with other layout methods](/guides/Grid_layout/Relationship_with_other_layout_methods)
- [Grid layout using line-based placement](/guides/Grid_layout/Line-based_placement)
- [Grid template areas](/guides/Grid_layout/Grid_template_areas)
- [Grid layout using named grid lines](/guides/Grid_layout/Named_grid_lines)
