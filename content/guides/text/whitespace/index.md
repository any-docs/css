...
```html live-sample___html-whitespace
<!doctype html>
...
Because this `<h1>` element contains only inline elements, it establishes an [inline formatting context](/guides/Inline_layout/Inline_formatting_context). This is one of the several layout rendering contexts that browser engines use to arrange content on the page.
