...
- [Using CSS filter effects](/guides/Filter_effects/Using)
...
- Properties in the [CSS compositing and blending](/guides/Compositing_and_blending) module enable blending an element's background layers together and blending an element with its container
