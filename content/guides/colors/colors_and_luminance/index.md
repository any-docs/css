...
description: Understanding color, luminance, and saturation is important for design and readability for all sighted users, they are essential for those with reduced vision and color-deficient vision and those with specific neurological, cognitive, and other impairments.
source: mdn
---
...
![Color picker with HSL and RGB, with color contrast values.](/images/microcolorsc.jpg)
...
![Snippet of Firefox developer tools showing the simulate popup](/images/simulate_color_differences.jpg)
...
![On the left is a cone mosaic of standard vision, and on the right is that of someone with protanopia where they are missing the red cones.](/images/conemosaics.jpg)
...
![An image of a checkerboard, where identical colors look different if they are in shadow](/images/yellowdotcheckershadow_dlyon.png)
...
![Red Saturation from Wikimedia Commons svg saved as png Attribution: Datumizer [CC0]](/images/320px-red_saturations.svg.png)
