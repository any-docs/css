...
This tool lets you enter or pick a color and copy its corresponding value in any CSS [color format](/reference/values/color_value). You can use the generated color value anywhere the `&lt;color&gt;` data type is supported in CSS. This tool can also help you understand the syntax of the different color notations.
...
- [Applying color with CSS properties](/guides/Colors/Applying_color)
