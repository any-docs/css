...
| Unit   | Relative to                                                                                                |
| ------ | ---------------------------------------------------------------------------------------------------------- |
| `dvh`  | 1% of the [dynamic](/reference/values/length#dynamic_viewport_units) viewport's height. |
| `dvw`  | 1% of the [dynamic](/reference/values/length#dynamic_viewport_units) viewport's width.  |
| `lvh`  | 1% of the [large](/reference/values/length#large_viewport_units) viewport's height.     |
| `lvw`  | 1% of the [large](/reference/values/length#large_viewport_units) viewport's width.      |
| `svh`  | 1% of the [small](/reference/values/length#small_viewport_units) viewport's height.     |
| `svw`  | 1% of the [small](/reference/values/length#small_viewport_units) viewport's width.      |
...
Container query length units specify a length relative to the dimensions of a [query container](/guides/Containment/Container_queries).
