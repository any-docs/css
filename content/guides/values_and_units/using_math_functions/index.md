...
In total, developers can use a combination of [nearly two dozen CSS math functions](/reference/values/Functions#math_functions) in their stylesheets. In this guide, we'll exemplify four of the more commonly-used, and introduce those more advanced.
...
- CSS math functions can sometimes be used instead of [CSS media queries](/guides/Media_queries/Using) to define layout breakpoints.
