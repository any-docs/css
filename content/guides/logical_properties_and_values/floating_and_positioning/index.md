...
The [CSS logical properties and values](/guides/Logical_properties_and_values) module contains logical mappings for the physical values of {{cssxref("float")}} and {{cssxref("clear")}}, and also for the positioning properties used with [positioned layout](/guides/Positioned_layout). This guide takes a look at how to use these.
