...
For more complex shapes, you will need to use one of the [basic shapes](/guides/Shapes/Using_shape-outside) as a value, or define your shape from an image as covered in other guides in this section.
