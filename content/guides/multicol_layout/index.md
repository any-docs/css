...
> [!NOTE]
> Multiple-column layout is closely related to [paged media](/guides/Paged_media). Each column box is a fragment, much like each printed page is a fragment of a document. Using the properties defined in the [CSS fragmentation](/guides/Fragmentation) module, you can control how content breaks between columns and pages.
...
- [Basic concepts of multi-column layouts](/guides/Multicol_layout/Basic_concepts)
  - Overview of the multiple-column layout specification.
- [Using multi-column layouts](/guides/Multicol_layout/Using)
...
- [Spanning and balancing](/guides/Multicol_layout/Spanning_balancing_columns)
  - How to make elements span across all columns and control the way columns are filled.
- [Handling overflow in multi-column layout](/guides/Multicol_layout/Handling_overflow)
