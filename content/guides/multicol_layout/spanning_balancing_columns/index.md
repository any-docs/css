...
In the next guide, you will learn [how multicol handles overflow](/guides/Multicol_layout/Handling_overflow) within columns and when there are more columns than can fit in the container.
